...
<body class="mt-5">
    <div class="jumbotron jumbotron-fluid mb-5">    
        <div class="container text-center">
            <h1 class="display-4">Bank Sampah Jejama Secancanan</h1>
            <h7 class="display-4">Dari Sampah Menjadi Berkah</h7>
        </div>
    </div>
    ...
    <div class="content" id="content">
        <div class="container">
            <div class="row justify-content-center mb-5">
                <div class="col-md-4">
                    <img src="<?= base_url('assets/post1'); ?>/post1.jpg" width="100%" class="image">
                </div>
                <div class="col-md-5">
